...
## Current GitHub Pages preview configuration

For `https://sepante.github.io/rezaemrani/`, `_config.yml` is set to:
...
When the custom domain is connected, change it to:
